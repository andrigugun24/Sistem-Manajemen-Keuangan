...
export default function KategoriTagihanCreate() {
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        post(route('kategori-tagihan.store'));
    };

    return (
        <div className="space-y-6 lg:space-y-8 font-display antialiased pb-10">
            <Head title="Tambah Kategori Tagihan" />
            ...
            <div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-4 mt-2">
                <div>
                    <div className="flex items-center gap-2 mb-2">
                        ...
                        <h1 className="text-[28px] font-bold text-slate-900 dark:text-white tracking-tight">Tambah Kategori Tagihan</h1>
                    </div>
                    <p className="text-slate-500 dark:text-slate-400 mt-1 text-sm md:text-base ml-7">Buat acuan dasar pembuatan tagihan keuangan siswa (SPP, DSP, Ekstrakurikuler, dll).</p>
                </div>
            </div>
            ...
            <div className="bg-white dark:bg-slate-900 rounded-[20px] border border-slate-200/60 dark:border-slate-800 shadow-sm overflow-hidden p-6 md:p-8 max-w-3xl">
                <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    {/* Jenis Tagihan - Radio Option Cards */}
                    ...
                    <div className="pt-6 border-t border-slate-100 dark:border-slate-800 flex items-center justify-end gap-3">
                        ...
                        >
                            ...
                            {processing ? 'Menyimpan...' : 'Simpan Kategori Tagihan'}
                        </button>
                    </div>
                </form>
            </div>
...
KategoriTagihanCreate.layout = page => (
