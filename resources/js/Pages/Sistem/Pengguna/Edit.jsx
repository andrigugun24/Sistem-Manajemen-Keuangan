...
import { ChevronLeft, Save, User, Mail, Lock, Shield, Users, Eye, EyeOff } from 'lucide-react';

export default function PenggunaEdit({ user, siswas = [], selected_siswa_ids = [] }) {
            ...
            <div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-4 mt-2">
                <div>
                    <div className="flex items-center gap-2 mb-2">
                        ...
                        <h1 className="text-[28px] font-bold text-slate-900 dark:text-white tracking-tight">Edit Pengguna</h1>
                    </div>
                    <p className="text-slate-500 dark:text-slate-400 mt-1 text-sm md:text-base ml-7">Perbarui informasi dan hak akses pengguna di sistem.</p>
                </div>
            </div>
                        ...
                        <div className="space-y-2">
                            ...
                            <div className="relative">
                                <input
                                    ...
                                    className={`w-full bg-slate-50 dark:bg-slate-800/50 border ${errors.password ? 'border-red-300 focus:ring-red-500/20 focus:border-red-500' : 'border-slate-200 dark:border-slate-700 focus:ring-blue-500/20 focus:border-blue-500/50'} rounded-xl px-4 py-3 pr-12 text-sm text-slate-900 dark:text-white placeholder-slate-400 transition-all focus:bg-white dark:bg-slate-900 focus:outline-none focus:ring-4`}
